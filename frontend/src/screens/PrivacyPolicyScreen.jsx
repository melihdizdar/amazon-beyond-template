...
import '../screens/Styles/Privacy/privacy.css';
    ...
    return (
        <div className="privacy">
            <div className="headerStage">
                ...
                <h1>How important is your privacy?</h1>
            </div>
                    ...
                    <div className="scroll-bg">
                        <div className="scroll-div">
                            <div className="scroll-object">
                                ...
                                <h4 id="How we use your information">How we use your information</h4>
                                <p>
                                ...
                                <h4 id="Cookies and Web Beacons">Cookies and Web Beacons</h4>
                                ...
                                <h4 id="Google DoubleClick DART Cookie">Google DoubleClick DART Cookie</h4>
                                <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – https://policies.google.com/technologies/ads</p>
                                <h4 id="Our Advertising Partners">Our Advertising Partners</h4>
                                <p>Some of advertisers on our site may use cookies and web beacons. Our advertising partners are listed below. Each of our advertising partners has their own Privacy Policy for their policies on user data. For easier access, we hyperlinked to their Privacy Policies below.</p>
                                <h4 id="Advertising Partners Privacy Policies">Advertising Partners Privacy Policies</h4>
                                ...
                                <h4 id="Third Party Privacy Policies">Third Party Privacy Policies</h4>
                                ...
                                <h4 id="CCPA Privacy Rights (Do Not Sell My Personal Information)">CCPA Privacy Rights (Do Not Sell My Personal Information)</h4>
                                ...
                                <h4 id="GDPR Data Protection Rights">GDPR Data Protection Rights</h4>
                                ...
                                <h4 id="Children's Information">Children's Information</h4>
