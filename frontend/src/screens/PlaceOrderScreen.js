...
import "../screens/Styles/PlaceOrder/placeorder.css"

export default function PlaceOrderScreen(props) {
    const cart = useSelector((state) => state.cart); //shipping kısmındaki cart'ı tanımladık
    if(!cart.paymentMethod){
        props.history.push('/payment'); //paymente döndüğü için otomatik olarak signin'e dönecek.
    }
